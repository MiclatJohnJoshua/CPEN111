...
image2 = imresize(imresize(image1,1/4),4);
subplot(232);
imshow(image2);
title('64x64 resolution');


image3 = imresize(imresize(image1,1/8),8);
subplot(233);
imshow(image3);
title('32x32 resolution');


image4 = imresize(imresize(image1,1/16),16);
subplot(234);
imshow(image4);
title('16x16 resolution');


image5 = imresize(imresize(image1,1/32),32);
subplot(235);
imshow(image5);
